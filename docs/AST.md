...
[variabledeclaration]: https://github.com/estree/estree/blob/master/es5.md#variabledeclaration
...
This is the `{let/const ...}` tag node.

```ts
interface SvelteDeclarationTag extends Node {
  type: "SvelteDeclarationTag";
  declaration: VariableDeclaration;
}
```

[VariableDeclaration] is a node defined in ESTree.
